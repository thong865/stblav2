...
import { f as defineStore, u as useNuxtApp } from '../server.mjs';
...
const useCity = async () => {
  const { data } = await useFetch("/api/city", "$eSgvhWcbVC");
  return {
    provinces: data
  };
};
const useSearchStore = defineStore("querySearch", {
  state: () => ({
    keyword: {},
    count: 0
  }),
...
export { useCity as a, useSearchStore as u };
//# sourceMappingURL=storeSearch-ea31f177.mjs.map

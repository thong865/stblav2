import { getCurrentInstance, unref, version, toRef, isRef, hasInjectionContext, inject, defineAsyncComponent, h, onUnmounted, shallowRef, ref, computed, defineComponent, Suspense, nextTick, Transition, provide, reactive, watchEffect, watch, Fragment, useSSRContext, createApp, effectScope, isReactive, toRaw, getCurrentScope, onScopeDispose, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRefs, markRaw, isReadonly, Text, isShallow, withCtx } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=500, initial-scale=1" }, { "charset": "utf-8" }, { "name": "description", "content": "ຝາກເງິນ, ຖອນເງິນ, ຊຳລະບິນ, ຈ່າຍເງິນ, ເງິນກູ້, ຂາຍຫຼັກຊັບ ຂອງ ທອທ" }], "link": [], "style": [], "script": [], "noscript": [], "charset": "utf-8", "viewport": "width=500, initial-scale=1", "title": "ທະນາຄານ ເອັສທີ ຈຳກັດ ປະກາດຂາຍຫຼັກຊັບ" };
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-e35b1380.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-a9109740.mjs').then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-6d81f128.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-158321fa.mjs').then((m) => m.default || m)
  },
  {
    name: "market-id",
    path: "/market/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-67a0a01b.mjs').then((m) => m.default || m)
  },
  {
    name: "market-search",
    path: "/market/search",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/search-e9beab5e.mjs').then((m) => m.default || m)
  }
];
...
const optionsLoader = () => Promise.resolve({ "locale": "lo", "fallbackLocale": "lo" });
const resource$1 = {
  "button": {
    "search": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["ຄົ້ນຫາ"]);
    }
  },
  "description": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Nuxt 3 + Tailwind + Eslint + i18n + Sentry Starter"]);
  }
};
const resource = {
  "button": {
  ...
  "form": {
    "search_all": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["ທັງໝົດ"]);
    },
    "search_province": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["ແຂວງ"]);
    },
    "search_district": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["ເມືອງ"]);
    },
    "search_category": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["ໝວດໝູ່"]);
    }
  }
};
const messages = { "en": resource$1, "lo": resource };
...
const layouts = {
  default: () => import('./_nuxt/default-74349b53.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-438e65bd.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-1e0c60fb.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useState as a, useRoute as b, createError as c, useRuntimeConfig as d, entry$1 as default, __nuxt_component_2 as e, defineStore as f, useHead as g, useRouter as h, navigateTo as n, resolveUnrefHeadInput as r, useNuxtApp as u };

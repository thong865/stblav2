...
<template>
    <div>
        <div class="card w-full bg-base-100 shadow">
            <figure>
                <img :src="`${streamUrl}${props.items?.image?.file}`" :alt="props.items?.title"
                    class="lazy rounded-xl max-h-[145.63px] md:max-h-[210px] lg:max-h-[210px] w-full" />
            </figure>
            ...
            <div class="flex justify-between px-2 py-2">
                <div class="flex gap-1 flex-row-reverse md:justify-between md:flex-row">
                    <button class="btn gap-2 btn-sm" @click="MeLike()">{{ pLike }} <svg xmlns="http://www.w3.org/2000/svg"
